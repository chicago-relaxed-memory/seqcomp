...
\ref{L4}, which is unchanged from \refdef{def:pomsets-trans}.
...
\end{definition}
\begin{proposition}
  Every \armeight{} execution is allowed by \refdef{def:pomsets-arm}.
  \begin{proof}[Proof Sketch]
    By \EGC{}, an \armeight{} execution linearization of local-order and
    per-location program order.  Every such linearization is also a valid
    pomset under \refdef{def:pomsets-arm}.
  \end{proof}
\end{proposition}
