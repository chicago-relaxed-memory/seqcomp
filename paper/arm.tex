...
\refdef{def:pomsets-down-rr} combines all of the features of
...
\begin{definition}[$\xCO$/$\xRASC$/$\xDGR$/$\xRRD$]
  ...
  \end{enumerate}  
\end{definition}
Here, we have repeated all of the rules for preconditions and transformers,
including \ref{L4}, which is unchanged from \refdef{def:pomsets-trans}.
