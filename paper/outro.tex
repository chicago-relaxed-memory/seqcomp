...
however, not an accident of our poor choices.  Relaxed memory models must
...
Given that \emph{complexity} cannot be eliminated from relaxed memory models, the
best one can do is attempt to understand its causes.  We have broken the
problem into eight manageable pieces, discussed throughout
\textsection\ref{sec:co}--\ref{sec:complications}.
