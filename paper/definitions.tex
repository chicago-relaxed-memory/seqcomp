...
\begin{definition}
  ...
  \begin{enumerate}[topsep=0pt]
    \setcounter{enumi}{4}
  \item[(\ref{par-E}--\ref{par-term})] as for $\sRPAR{}{}$,
  \item \label{seq-rf1}
  ...
  \item \label{seq-release}
    if $\labeling(\aEv)$ is a release for some $\aEv\in\aEvs_2$ then $\labelingForm(\aEv)$ implies $\aTerm[1]$,
  ...
  \begin{enumerate}[topsep=0pt]
    \setcounter{enumi}{3}
  \item[(\ref{par-E}--\ref{par-le})] as for $\sRPAR{}{}$,
  \item
    \label{if-rf}
