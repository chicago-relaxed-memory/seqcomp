...
consider pomsets that are augment-minimal.  % The
...
reasoning of \PwT{}, but more brittle.
\begin{gather*}
  \PW{x}{0}
  \SEMI
  \PBR{
  ...
  \hbox{\begin{tikzinline}[node distance=.5em and 1.5em]
    ...
    \end{tikzinline}}    
\end{gather*}
\PwT{} correctly allows this execution; \MRD{} forbids it. The precondition
of $\DW{y}{1}$ is a tautology, but the co-product mechanism in \MRD{} does not
recognize this and will seek a isomorphic justification under the $\DR{x}{2}$
branch of the read in the event structure, and fail to find it, leaving the
dependency in place.
...
\todo{Verify that this is a tautology!}
