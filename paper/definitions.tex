...
\begin{definition}
  ...
  \reffig{fig:sem}, with two changes in the definition of sequential
  composition:
  \begin{itemize}
  \item remove \eqref{seq-le-rf},
  \item add \labeltext[\textsc{s}7d]{(\textsc{s}7d)}{seq-le-rf2} if
    $\labeling_1(\cEv) \rblocks \labeling_2(\aEv)$ then $\bEv\xrfx\aEv$
    implies $\cEv\le\bEv$,
  \item
