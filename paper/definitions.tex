...
\begin{definition}
  ...
  is a tuple $(\aEvs, \labeling, \labelingForm, \aTr{}{}, {\le}, {\rrfx})$ where
  \begin{enumerate}
  ...
  \item
    ${\rrfx} \subseteq (\Event\times\Event)$, is a relation capturing
    \emph{reads-from}.
  \end{enumerate}
\end{definition}
...
\begin{definition}
  ...
  \item \label{seq-kappa12}
    ...
    % \\ \makebox[5em]{}
    where
    $\labelingForm'_2(\aEv)=\aTr[1]{{\downarrow}\aEv}{\labelingForm_2(\aEv})$,\\
    where ${\downarrow}\aEv=\{ \cEv \mid \cEv \lt \aEv \}$ if $\labeling(\aEv)$ is a write,
    and ${\downarrow}\aEv=\aEvs_1$, otherwise,
  \item \label{seq-tau}
...
Full versions:
  ...
  \begin{enumerate}[topsep=0pt]
  \item
    $\bigvee_{\aEv\in\aEvs}\cForm_\aEv$ is a tautology and
