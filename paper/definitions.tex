...
\begin{example}
  ...
  one used traditionally, which is written using substitution.  Attempting to
  write the predicate transformers in this style we arrive at:
  \begin{enumerate}
  \item[\ref{L4})]
  ...
  attempt to define predicate transformers using substitution fails.
\end{example}
...
constituent parts, building on \refdef{def:pomsets-trans}.  In
