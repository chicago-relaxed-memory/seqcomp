...
\begin{definition}
  ...
  is a tuple $(\aEvs, \labeling, \labelingForm, \aTr{}{}, {\le}, {\rrfx}, {\rrmw})$ where
  \begin{enumerate}
  ...
  \item
    ${\rrfx} \subseteq (\Event\times\Event)$, is a relation capturing \emph{reads-from},
  \item
...
\begin{definition}
  % \noindent
  If $\aPS \in (\aPSS_1\sRPAR\aPSS_2)$ then  
  ...
  \item \label{par-E}
    ...
    ${\rrmw}\supseteq\PBR{{\rrmw_1}\cup{\rrmw_2}}$, 
  ...
  \item
    ${\rrfx}\subseteq\PBR{{\rrfx_1}\cup{\rrfx_2}\cup(\aEvs_1\times \aEvs_2)\cup(\aEvs_2\times \aEvs_1)}$, 
  \end{enumerate}
  ...
  \item[(\ref{par-E}--\ref{par-lambda2})] as for $\sRPAR$,
  ...
  \item
    ${\rrfx}\subseteq\PBR{{\rrfx_1}\cup{\rrfx_2}}$, 
  \end{enumerate}
  ...
  $(\exists\aPS_1\in\aPSS_1)$ $(\exists\aPS_2\in\aPSS_2)$
  \begin{enumerate}[resume]
  \item[(\ref{par-E})] as for $\sRPAR$,
  \item \label{seq-reorder}
    \textcolor{red}{if $\bEv\in\aEvs_1$ and $\aEv\in\aEvs_2$ then either $\bEv\le\aEv$ or $\labeling_1(\bEv)\reorderlt\labeling_2(\aEv)$,}  
  ...
  \item \label{seq-kappa2}
    ...
    where \textcolor{red}{$\cEvs=\{ \cEv \mid \cEv \le \aEv \}$} and $\labelingForm'_2(\aEv)=\aTr[1]{\cEvs}{\labelingForm_2(\aEv})$, 
  ...
  \item
    ...
    $\aTerm$ implies $\bigvee_{\aEv\in\aEvs}\cForm_\aEv$,
  \item
    $\labelingAct(\aEv) = \DR[\bmode]{\aLoc}[\ascope]{\aVal_\aEv}$
  \item
    $\labelingForm(\aEv)$ implies
    \begin{math}
      \cForm_\aEv
  ...
  \begin{scope}
    ...
    \begin{gather*}
      ...
      \begin{aligned}
        ...
        &
        \sem{\aCmd_1 \RPAR \aCmd_2} &= \sem{\aCmd_1}\sRPAR\sem{\aCmd_2}
        \\
...
\begin{definition}
  ...
  \begin{align*}
    ...
    &
    \sem{\aCmd_1 \PAR \aCmd_2} &= \sem{\aCmd_1}\sPAR\sem{\aCmd_2}
    % \\
...
\begin{definition}
  ...
  \begin{gather*}
    ...
    \begin{aligned}
      ...
      &
      \makebox[3.5em][r]{$\sem{\aCmd_1 \PAR \aCmd_2}$} &= \sem{\aCmd_1}\sPAR\sem{\aCmd_2}
    \end{aligned}
  \end{gather*}
\end{definition}
