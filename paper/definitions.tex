...
OOPSLA is non-skolemized, using substitution instead, and collapsing $\aLoc$
and $\aReg$.
...
\begin{definition}
  ...
  \item \label{if-tau}
    $\aTr[\bEvs]\SB0(\aForm)$ implies $(\bForm\land\aTr[\bEvs%\cap\aEvs_1
    ]_1(\aForm))\lor(\neg\bForm\land\aTr[\bEvs%\cap\aEvs_2
    ]_2(\aForm))$.
  \end{enumerate}
  ...
  \item \label{seq-kappa12}
    ...
    \\ where $\labelingForm'_2(\aEv)=\aTr[\cEvs%\cap\aEvs_1
  ...
  \item[{\labeltext[S5]{S5)}{S5}}]
    $\aTr[\cEvs]\SB0(\aForm)$ implies $\aForm[\aExp/\aLoc]$, % \land % \lnot\Q{}$.
  ...
  %   $\aVal{=}\aReg\limplies\aForm$, 
  % \item[{\labeltext[L5]{L5)}{L5}}]
  %   % if $\bEvs=\emptyset$ then
  %   $\aTr[\emptyset]\SB0(\aForm)\;$ implies $((\aLoc{=}\aReg\lor\aVal{=}\aReg)\limplies\aForm) \land \lnot\Q{}$.
  % \item[{\labeltext[L6]{L6)}{L6}}]
  %    if $\aEvs=\emptyset$ then
  %   $\aTr[\emptyset]\SB0(\aForm)\;$ implies $\aForm \land \lnot\Q{}$.
  % \end{enumerate}
  ...
  \item[{\labeltext[L5]{L5)}{L5}}]
    $\aTr[\cEvs]\SB0(\aForm)$ implies $((\aLoc{=}\aReg\lor\aVal{=}\aReg)\limplies\aForm)$, % \land \lnot\Q{}$,
    \\ where $\bEvs\cap\aEvs\neq\emptyset$ and $\cEvs\cap\aEvs=\emptyset$,
  \end{enumerate}
  or
  $\aEvs=\emptyset$ and 
  \begin{enumerate}
  \item[{\labeltext[L6]{L6)}{L6}}] 
    $\aTr[\cEvs]\SB0(\aForm)\;$ implies $\aForm$. % \land \lnot\Q{}$.
  \end{enumerate}
\end{definition}
...
OOPSLA is non-skolemized---with $[x/r]$ rather than no substitution.
\begin{enumerate}
\item[\ref{L4})]
...
%       \xform{xid}{(((x{=}r\lor1{=}r)\limplies\aForm))[r/y]\land r{=}1}{right=of xdi}
%       \event{a1}{\DR{x}{1}}{above=of xdi}
%       \event{a2}{((x{=}r\lor1{=}r)\limplies r{=}1)\mid\DW{y}{1}}{right=of a1}
%       \xform{xdd}{((1{=}r)\limplies\aForm)[r/y]\land r{=}1}{above right=.5em and -1em of a1}
...
\begin{align*}
  \begin{gathered}
    ...
    \hbox{\begin{tikzinline}[node distance=.5em and 1.5em]
        \xform{xd}{(1{=}r)\limplies\aForm}{}
        \xform{xi}{((x{=}r\lor1{=}r)\limplies\aForm)\land \lnot\Q{}}{below=of xd}
        \event{a1}{\DR{x}{1}}{above=of xd}
        \xo{a1}{xd}
      \end{tikzinline}}    
  \end{gathered}
...
\begin{gather*}
  ...
  \hbox{\begin{tikzinline}[node distance=.5em and 1.5em]
      ...
      \xform{xid}{(((x{=}r\lor1{=}r)\limplies\aForm)\land \lnot\Q{})[r/y]\land (\Q{}\limplies r{=}1)}{below right=.5em and -10em of xdi}
      \event{a1}{\DR{x}{1}}{above=of xdi}
      ...
      \xform{xii}{(((x{=}r\lor1{=}r)\limplies\aForm)\land \lnot\Q{})[r/y]\land \lnot\Q{}}{below=of xid}
      \xo{a1}{xdi}
      \xo{a2}{xid}
      \xo{a1}{xdd}
      \xo{a2}{xdd}
