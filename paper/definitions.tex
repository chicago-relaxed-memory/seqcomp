...
\item formulae are closed under negation, conjunction, disjunction, and
  ...
  % and $[\aForm/\aSym]$ for each symbol $\aSym$,
...
\begin{definition}
  ...
  \begin{enumerate}
  \item $\labelingForm(\aEv)$ is a tautology,    
  \item if $\labeling(\aEv)=\DRP{}{}$ then $(\exists\bEv)\;(\bEv,\aEv)\in{\rrfx}$.
  \end{enumerate}
\end{definition}
  ...
  \begin{scope}
    ...
    \begin{gather*}
      ...
      \begin{aligned}
        ...
        &
        \sem[\aThrd]{\aCmd_1 \RPAR[\bThrd] \aCmd_2} &= \sRPAR{\sem[\bThrd]{\aCmd_1}}{\sem[\aThrd]{\aCmd_2}}
        \\
