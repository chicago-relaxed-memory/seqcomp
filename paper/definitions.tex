...
% We write $\DWP[\gemode\mRA]{}{}$ to stand for either
% $\DWP[\mRA]{}{}$ or $\DWP[\mSC]{}{}$, and similarly for other actions and
% modes.
...
Action $\DWP{\aLoc}{\aVal}$ \emph{blocks} $\DRP{\aLoc}{\bVal}$, for any $\aVal$, $\bVal$.
  ...
  {\reorderra}
    =
    \{(\aAct,             \DW[\gemode\mRA]{}{}     )\C
    (\aAct,               \DF{\gemode\mREL}        )\C
    (\DR{}{},             \DF{\gemode\mACQ}        )\C
    (\DR{\aLoc}{},        \DR[\gemode\mRA]{\aLoc}{})\C
    (\DR[\gemode\mRA]{}{},\aAct                    )\C
    (\DF{\gemode\mACQ},   \aAct                    )\C
    (\DF{\gemode\mREL},   \DW{}{}                  )\C
    (\DW[\gemode\mRA]{\aLoc}{},\DW{\aLoc}{})\}
  \end{math}.
