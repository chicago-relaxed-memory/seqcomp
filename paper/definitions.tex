...
In formulae, (in)equations have precedence over logical operators; thus
$\aReg{=}\aVal\limplies\bReg{>}\bVal$ is read
$(\aReg{=}\aVal)\limplies(\bReg{>}\bVal)$.  Implication associates to the
...
\begin{definition}
  A pomset with predicate transformers is a pomset with preconditions (\refdef{def:pomsets-pre}),
