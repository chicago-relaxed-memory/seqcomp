...
\begin{definition}
  ...
  \item[{\labeltext[L5]{L5)}{L5}}]
    ...
    % \newcounter{pomsetXLoadCount}
    % \setcounter{pomsetXLoadCount}{\value{enumi}}
  \end{enumerate}
\end{definition}
...
\begin{gather*}
  ...
  \hbox{\begin{tikzinline}[node distance=.5em and 1.5em]
      ...
      \xform{xid}{((x{=}r\lor1{=}r)\limplies\aForm[r/x][1/y])\land \lnot\Q{}}{below right=.5em and -4em of xdi}
      \event{a1}{\DR{x}{1}}{above=of xdi}
      \event{a2}{(1{=}r\limplies r{=}1\mid\DW{y}{1}}{above=2.7em of xid}
      \xform{xdd}{((1{=}r)\limplies\aForm[r/x][1/y])\land (\Q{}\limplies r{=}1)}{above right=.5em and -1em of a1}
      \xform{xii}{((x{=}r\lor1{=}r)\limplies\aForm[r/x][1/y])\land \lnot\Q{}}{below=of xid}
      \xo{a1}{xdi}
      \xo{a2}{xid}
...
Replaying those examples without $\Q{}$:
\begin{align*}
\begin{gathered}
  \PW{x}{1}
  \\
  \hbox{\begin{tikzinline}[node distance=.5em and 1.5em]
      \event{a1}{1{=}1\mid\DW{x}{1}}{}
      \xform{x1d}{\aForm[1/x]\land 1{=}1}{below=of a1}
...
\begin{gathered}
  ...
  \hbox{\begin{tikzinline}[node distance=.5em and 1.5em]
      \event{a1}{2{=}1\mid\DW{x}{1}}{}
      \xform{x1d}{\aForm[2/x]\land 2{=}1}{below=of a1}
...
%   \hbox{\begin{tikzinline}[node distance=.5em and 1.5em]
%       \event{a1}{1{=}1\lor2{=}1\mid\DW{x}{1}}{}
%       \xform{x1d}{(\aForm[1/x]\land 1{=}1)[2/x]\land 2{=}1}{below=of a1}
...
%   \hbox{\begin{tikzinline}[node distance=.5em and 1.5em]
%       \event{a1}{\DW{x}{1}}{}
%       \xform{x1d}{\aForm[1/x]\land 1{=}1 \land 2{=}1}{right=of a1}
...
\begin{gather*}
  ...
  \hbox{\begin{tikzinline}[node distance=.5em and 1.5em]
      \event{a1}{\DW{x}{1}}{}
      \xform{x1d}{(\aForm[1/x])[2/x]}{right=of a1}
      \xform{x1i}{(\aForm[1/x])[2/x]}{below=of x1d}
      \xo{a1}{x1d}
    \end{tikzinline}}
\end{gather*}
...
\begin{gather*}
  ...
  \hbox{\begin{tikzinline}[node distance=.5em and 1.5em]
      ...
      \event{a1}{\DW{x}{1}}{above left=.5em and -1em of xdd}
      \event{a2}{\DW{x}{2}}{above right=.5em and -1em of xdd}
      \xform{xii}{\aForm[1/x]}{below=of xdd}
      \xo{a1}{xdi}
      \xo{a2}{xid}
      \xo{a1}{xdd}
      \xo{a2}{xdd}
...
\begin{align*}
  ...
  \begin{gathered}
    ...
    \\
    \hbox{\begin{tikzinline}[node distance=.5em and 1.5em]
        \xform{xd}{\aForm[1/y]\land r{=}1}{}
        \xform{xi}{\aForm[1/y]}{below=of xd}
        \event{a2}{r{=}1\mid\DW{y}{1}}{above=of xd}      
        \xo{a2}{xd}
      \end{tikzinline}}    
  \end{gathered}
...
\begin{gather*}
  ...
  \\
  \hbox{\begin{tikzinline}[node distance=.5em and 1.5em]
      \xform{xdi}{((1{=}r)\limplies\aForm[r/x])[1/y]}{}
      \xform{xid}{(((x{=}r\lor1{=}r)\limplies\aForm[r/x]))[1/y]\land r{=}1}{right=of xdi}
      \event{a1}{\DR{x}{1}}{above=of xdi}
      \event{a2}{((x{=}r\lor1{=}r)\limplies r{=}1)\mid\DW{y}{1}}{right=of a1}
      \xform{xdd}{((1{=}r)\limplies\aForm[r/x])[1/y]\land r{=}1}{above right=.5em and -1em of a1}
      \xform{xii}{(((x{=}r\lor1{=}r)\limplies\aForm[r/x]))[1/y]}{below=2.7em of a2}
      \xo{a1}{xdi}
      \xo{a2}{xid}
      \xo{a1}{xdd}
      \xo{a2}{xdd}
...
\begin{gather*}
  ...
  \hbox{\begin{tikzinline}[node distance=.5em and 1.5em]
      \xform{xdi}{((1{=}r)\limplies\aForm[r/x][1/y])}{}
      \xform{xid}{((x{=}r\lor1{=}r)\limplies\aForm[r/x][1/y])}{right=of xdi}
      \event{a1}{\DR{x}{1}}{above=of xdi}
      \event{a2}{((x{=}r\lor1{=}r)\limplies r{=}1)\mid\DW{y}{1}}{right=of a1}
      \xform{xdd}{((1{=}r)\limplies\aForm[r/x][1/y])\land r{=}1}{above right=.5em and -1em of a1}
      \xform{xii}{((x{=}r\lor1{=}r)\limplies\aForm[r/x][1/y])}{below=2.7em of a2}
...
% Extend the definition of $\sSTOP$ so that $\TICK$ is true.
...
\begin{definition}$\phantom{\;}$\par
  % \noindent
  % If $\aPS\SB0\in\sSTOP$ then $\aEvs\SB0 = \emptyset$ and $\TICK$.
