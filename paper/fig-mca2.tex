\begin{figure}
  ...
  \raggedright
  \noindent
  Suppose $\aRel_1$ is a relation over $\aEvs_1$ and $\aRel$ is a relation over $\aEvs\supseteq\aEvs_1$.  %\subseteq\aEvs_1\times\aEvs_1$. % and $\aRel_2\subseteq\aEvs_2\times\aEvs_2$.
