\begin{figure}
  \bookmark{PwT-MCA Semantics 2}
  \raggedright
  \noindent
  Suppose $\aRel_1$ is a relation over $\aEvs_1$.  %\subseteq\aEvs_1\times\aEvs_1$. % and $\aRel_2\subseteq\aEvs_2\times\aEvs_2$.
  We say $\aRel \rextendsdef{\aRel_1}{}$ %{\aRel_2}$
  if
  % $\aRel\supseteq (\aRel_1\cup \aRel_2)$ and
  $\aRel\cap(\aEvs_1\times \aEvs_1) = \aRel_1$.
  %and $\aRel\cap(\aEvs_2\times \aEvs_2) = \aRel_2$.
  \medskip
