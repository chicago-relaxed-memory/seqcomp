...
\begin{definition}
  ...
  \begin{enumerate}
  \item[(\textsc{p}8)] (\textsc{s}8)\; (\textsc{c}8)\; ${\rrmw}=\PBR{{\rrmw_1}\cup{\rrmw_2}}$,
  \end{enumerate}
\end{definition}
...
\item[] \setcounter{enumi}{\value{kappa}} \labeltextX{3}{s}{seq-kappa-merge}
  ...
  \item \label{seq-kappa-merge12}
    ...
    \begin{itemize}
    \item $\labeling(\aEv)=\labeling_1(\aEv)=\labeling_2(\aEv)$ and $\labelingForm(\aEv) \rimplies \labelingForm_1(\aEv)\lor\labelingForm'_2(\aEv)$,
    \item $\labeling(\aEv)=\labeling_1(\aEv)\neq\labeling_2(\aEv)$ and $\labelingForm(\aEv) \rimplies \labelingForm_1(\aEv)$,
    \item $\labeling(\aEv)=\labeling_2(\aEv)\neq\labeling_1(\aEv)$ and $\labelingForm(\aEv) \rimplies \labelingForm'_2(\aEv)$.
    \end{itemize}
  \end{enumerate}
\end{enumerate}
