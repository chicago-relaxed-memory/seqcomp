...
for example, $\PW{x}{1}\SEMI\PW{x}{2}$ can be refined to $\PW{x}{2}$.  A list
of safe merges can be found in \cite[\textsection
...
To accommodate such merges, define $\fmerge{}{}:\Act\times\Act\fun2^{\Act}$
as follows, where $\lubmode$ is the least upper bound with respect the order
on modes from \textsection\ref{sec:actions}.
\begin{align*}
  \begin{aligned}
