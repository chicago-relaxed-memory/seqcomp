...
\end{displaymath}
The semantics of \citet{DBLP:journals/pacmpl/JagadeesanJR20} does not
validate redundant load elimination or \eqref{TC2}, contrary to the claim.
...
To support \RMW{}s, we add a relation
