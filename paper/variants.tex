...
%   \end{aligned}
% \end{align*}
Then we can replace \ref{seq-lambda} in \reffig{fig:sem} by:
...
\item[] \setcounter{enumi}{\value{kappa}} \labeltextX{3}{s}{seq-kappa}
  ...
  \item \label{seq-kappa-merge12}
    ...
    \begin{itemize}
    \item $\labeling_1(\aEv)=\labeling_2(\aEv)$ and $\labelingForm(\aEv) \rimplies \labelingForm_1(\aEv)\lor\labelingForm'_2(\aEv)$,
    \item $\labeling_1(\aEv)\neq\labeling_2(\aEv)$ and $\labelingForm(\aEv) \rimplies \labelingForm_1(\aEv)\land\labelingForm'_2(\aEv)$,
    \end{itemize}
  \end{enumerate}
\end{enumerate}
