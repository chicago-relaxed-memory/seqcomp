...
\labeltext[\textsc{cdrf-rlx}]{relaxed variant of the \textsc{cdrf}
  example}{CDRF-RLX} from \citet{DBLP:conf/pldi/LeeCPCHLV20}, using
...
To see why, consider the independent
