...
\begin{definition}
  Let $\semreg{}$ be defined as for $\semrr{}$ in \refdef{def:semrr} and
  \reffig{fig:sem}, changing \ref{read-tau} of $\sLOAD{}{}$:
...
\begin{definition}
  Let $\semca{}$ be defined as for $\semrr{}$ in \refdef{def:semrr} and
  \reffig{fig:sem}, changing $\sSTORE{}{}$ and $\sLOAD{}{}$.  
...
\label{sec:addr}
\begin{definition}
  Let $\semaddr{}$ be defined as for $\semrr{}$ in \refdef{def:semrr} and
  \reffig{fig:sem}, changing $\sSTORE{}{}$ and $\sLOAD{}{}$.  
