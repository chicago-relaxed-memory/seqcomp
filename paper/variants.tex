...
\reffig{fig:seq}, but they apply equally to the variants described in
...
\begin{gather*}
  ...
  \hbox{\begin{tikzinline}[node distance=1.5em]
    ...
    \end{tikzinline}}
\end{gather*}
This execution is not allowed by the semantics $\sembase{}$ of \reffig{fig:seq}: the precondition of
