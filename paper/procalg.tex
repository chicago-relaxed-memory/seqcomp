...
concurrency~\cite{DBLP:books/daglib/0067019,DBLP:books/ph/Hoare85,DBLP:books/daglib/0069083} and have been given many different
...
Process algebra as sets of pomsets
\begin{definition}
...
\begin{definition}
  ...
  \item[1--\thepomsetParDisjointCount)] as in Definition~\ref{tab:pomsets},
  ...
  \item[1--\thepomsetPrefixCount)] as in Definition~\ref{tab:pomsets} (ignoring \thepomsetPrefixOrderCount),
  ...
  \item[1--\thepomsetParCount)] as in $(\aPSS_1\sPAR\aPSS_2)$  in
    Definition~\ref{tab:pomsets} (ignoring \thepomsetParDisjointCount),
...
\\
  ...
  \textstyle\bigcup_\aVal \recv\aChan{\aVal} \wPREFIX[\aVal/\aVar] \aPSS
\end{eqnarray*}
...
\begin{definition}
  ...
  \item[1--\thepomsetPreIfCount)] as in Definition~\ref{tab:pomsets-pre},
...
\\
  \sRECV\aChan\aVar & = &
  \textstyle\bigcup_\aVal \recv\aChan{\aVal}[\aVal/\aVar]
\end{eqnarray*}
