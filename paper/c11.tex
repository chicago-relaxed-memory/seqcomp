...
\ref{seq-m-exclude} states that phantom events cannot merge.
\ref{seq-m-phantom-forall} states that new phantom events must correspond to merges.
\ref{seq-m-phantom-exists} states that every merged event must have
