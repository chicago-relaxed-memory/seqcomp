...
The transformer for the \emph{right composition} $\aCmd_1\RPAR\aCmd_2$ takes
the register state from the right, but quiescence from both sides.
\begin{align*}
  \aCmd
  \BNFDEF& \ABORT
  \BNFSEP \SKIP
    ...
    \begin{align*}
      \begin{gathered}
        \begin{gathered}[t]
          ...
          \\
          \hbox{\begin{tikzinline}[node distance=.5em and 1.5em]
              \event{a}{\aExp{=}v\bigmid\DW[\mRLX]{x}{v}}{}
        ...
        \begin{gathered}[t]
          ...
          \\
          \hbox{\begin{tikzinline}[node distance=.5em and 1.5em]
              \event{a}{\Q{} \land \aExp{=}v\bigmid\DW[\amode]{x}{v}}{}
              \xform{xi}{\bForm[\FALSE/\Q{}]}{above=of a}
              \xform{xd}{\bForm\land\aExp{=}\aVal}{below=of a}
              \xo[xright]{a}{xd}
            \end{tikzinline}}
  ...
  \begin{gather*}
    \begin{gathered}
      \begin{gathered}[t]
        ...
        \\
        \hbox{\begin{tikzinline}[node distance=.5em and 1.5em]
            \raevent{a}{\Qr{*}\land\Qw{*}\land\aExp{=}v\bigmid\DW[\mREL]{x}{v}}{}
    ...
    \begin{gathered}
      \begin{gathered}[t]
        ...
        \\
        \hbox{\begin{tikzinline}[node distance=.5em and 1.5em]
            \raevent{a}{\Qw{x}\land\Qr{*}\bigmid\DR[\fACQ]{x}{v}}{}
    ...
    \begin{gathered}[t]
      ...
      \\
      \hbox{\begin{tikzinline}[node distance=.5em and 1.5em]
          \scevent{a}{\Qr{*}\land\Qw{*}\land\Qsc\land\aExp{=}\aVal\bigmid\DW[\fSC]{x}{v}}{}
          \xform{xi}{\bForm[\FALSE/\Qr{*}][\FALSE/\Qw{*}][\FALSE/\Qsc]}{above=of a}
          \xform{xd}{\bForm\land\aExp{=}\aVal}{below=of a}
          \xo[xright]{a}{xd}
        \end{tikzinline}}
    ...
    \begin{gathered}[t]
      ...
      \\
      \hbox{\begin{tikzinline}[node distance=.5em and 1.5em]
          \scevent{a}{\Qr{*}\land\Qw{*}\land\Qsc\bigmid\DR[\fSC]{x}{v}}{}
          \xform{xi}{\bForm[\FALSE/\Qr{*}][\FALSE/\Qw{*}][\FALSE/\Qsc]}{above=of a}
          \xform{xd}{v{=}r\limplies\bForm}{below=of a}
          \xo[xright]{a}{xd}
        \end{tikzinline}}
...
\begin{example}
  ...
  %     \hbox{\begin{tikzinline}[node distance=0.5em and 1.5em]
  %       \raevent{b}{\DR[\mACQ]{x}{2}}{}
  %       \event{c}{\Dx{x}\bigmid\DW{y}{1}}{right=.7em of b}
  %     \end{tikzinline}}  
  %   \end{gathered}  
  % \end{align*}
...
\begin{definition}[\xADDR]
  ...
  \item[\ref{L4})] $\aTr{\bEvs}{\bForm} \rimplies (\cExp{=}\cVal\limplies\aVal{=}\aReg)\limplies\bForm$, 
    % \item[\ref{L5})] $(\forall\dVal)$ $\aTr{\cEvs}{\bForm} \rimplies \cExp{=}\dVal \limplies (\aVal{=}\aReg\lor \REF{\dVal}\EQ\aReg)\limplies\bForm$,
