\begin{figure*}
  \begin{center}
    ...
    \end{minipage}
  \end{center}
  \caption{Full Semantics with Address Calculation (See
...
\begin{center}
  ...
  \begin{tabular}{c|ccc|ccc|ccc}
    ...
    \hline
    $1^{\text{st}}$& $\DR[\mRLX]{}{}$ & $\DR[\mRA]{}{}$ & $\DR[\mSC]{}{}$ & $\DW[\mRLX]{}{}$ & $\DW[\mRA]{}{}$ & $\DW[\mSC]{}{}$ & $\DF{\mACQ}$ & $\DF{\mREL}$ & $\DF{\mSC}$\\
    \hline
    $\DR[\mRLX]{}{}$ & \cmark & \cmark & \cmark & \cmark & \xmark & \xmark & \xmark & \xmark & \xmark \\
    $\DR[\mRA]{}{}$  & \xmark & \cmark & \xmark & \xmark & \xmark & \xmark & \xmark & \xmark & \xmark \\
    $\DR[\mSC]{}{}$  & \xmark & \xmark & \cmark & \xmark & \xmark & \xmark & \xmark & \xmark & \xmark \\
    \hline
    $\DW[\mRLX]{}{}$ & \cmark & \cmark & \cmark & \cmark & \xmark & \xmark & \cmark & \xmark & \xmark \\
    $\DW[\mRA]{}{}$  & \cmark & \cmark & \cmark & \cmark & \cmark & \xmark & \cmark & \xmark & \xmark \\
    $\DW[\mSC]{}{}$  & \cmark & \cmark & \xmark & \cmark & \xmark & \cmark & \cmark & \xmark & \xmark \\
    \hline
    $\DF{\mACQ}$ & \xmark & \xmark & \xmark & \xmark & \xmark & \xmark & \cmark & \xmark & \cmark \\
...
[The logical version of synchronization will use the distinction between
reads and writes that is already there for coherence.]
...
\begin{figure*}[t]
  ...
  \begin{center}
    ...
    \end{minipage}
  \end{center}
  \caption{Simplified Quiescence Semantics without Address Calculation (See
    \refdef{def:dlx} for $\DS{\aLoc}{\amode}$ and $\DLX{\aLoc}{\amode}{\bmode}$)} 
  \label{fig:no-q-or-addr}
\end{figure*}    

\subsection{Using Independency for Coherence and Synchronization}
...
\begin{scope}
  ...
  \begin{definition}
    ...
    \item
      ...
      $\bEv\le\aEv$ or $a\reorder\labeling_2(\aEv)$.
    \end{enumerate}
...
\begin{figure*}
  ...
  \begin{center}
    ...
    \end{minipage}
  \end{center}
  \caption{Simplified Quiescence Semantics with Address Calculation  (See
    \refdef{def:DS} for $\DL{\aLoc}{\amode}$)} 
  \label{fig:no-q}
\end{figure*}    
