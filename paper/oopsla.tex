...
flip $(\IF{b})$.
% Using a combination of read introduction and case analysis,
...
there is no difference between \PwTmca{1} and \PwTmca{2}.)

The examples in \cite{promising-ldrf} are more complex.  Here is one, dubbed
\textsc{ldrf-fail-ps}:
\begin{gather*}  
...
and \cite[\textsection6]{DBLP:journals/pacmpl/JagadeesanJR20}.
