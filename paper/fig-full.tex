...
\item[\ref{S4})]
  ...
  \begin{math}
    ...
    \limplies \PBR{
      ...
      [(\QwREF{\cVal_\aEv}\land\aExp{=}\aVal_\aEv)/\QwREF{\cVal_\aEv}]
    }
  \end{math},
\item[\ref{S5})] 
  \begin{math}    
...
\item[\ref{L5})] 
  ...
  \begin{math}
    ...
    \limplies        
    \PBRbig{
      \DL{\REF{\cVal_\aEv}}{\amode} \land
      \PBRbig{
        ((\cExp{=}\cVal_\aEv\limplies\aVal_\aEv{=}\uReg{\aEv})\lor\RW)
        \limplies (\aVal_\aEv{=}\uReg{\aEv}\lor\REF{\cVal_\aEv}{=}\uReg{\aEv}) 
        \limplies
        \bForm
        [\uReg{\aEv}/\aReg]
