...
% Mon 20 - Fri 24 June 2022, San Diego, California, United States
% Isil Dillig
% Brian Demsky
% Mike Dodds
% Doug Lea
...
% DePaul final exams start Wed 16.
% Amal Ahmed, Jan Vitek
%
% Submitted papers must be at most 23 pages in 10 point font. There is no
% page limit on references. No appendices are allowed on the main paper,
% instead authors can upload supplementary material with no page or content
% restrictions, but reviewers may choose to ignore it. Submissions must
% adhere to the “ACM Small” template available from the ACM.
...
\documentclass[acmsmall,screen,review]{acmart}\settopmatter{printfolios=true}
...
\title{The Leaky Semicolon (Draft Revision for Artifact Evaluation)}
