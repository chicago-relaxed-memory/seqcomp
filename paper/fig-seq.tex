\begin{figure}
  ...
  \begin{math}
    \kappaE{}=
    {\textstyle\bigvee{}\!\!{}_{\aEv\in\aEvs}\labelingForm(\aEv)}.
  \end{math}
  \todo{Remind that $\textstyle\bigvee\emptyset = \FALSE$}
  \medskip
      ...
      \item \label{read-tau-dep}
        ...
        \makebox[0pt][l]{%
          \begin{math}
            ...
            \limplies \bForm,
          \end{math}
          \todo{Degenerates to \ref{read-tau-empty} when $\labelingForm(\aEv)=\FALSE$.}
        }
