...
\begin{example}
  ...
  possible for $(\REF{r} \GETS 0\SEMI \REF{0}\GETS \BANG r)$ alone.

  If-closure, as in Figure~\ref{fig:full}, enables this execution:
  \begin{align*}
    \begin{gathered}
      \REF{r} \GETS 0
      \\
  ...
  \jjr{}, but allowed here.  Sequencing, we have: 
  \begin{align*}
    \begin{gathered}
      \REF{r} \GETS 0
      \SEMI
