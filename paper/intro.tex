...
% \end{itemize}
% % Acknowledgments go here, once we're not double-blinded.
...
% implementers balk at the prospect, due to significant costs.
...
\begin{align*}
  ...
  \begin{gathered}
    ...
    \\
    \hbox{\begin{tikzinline}[node distance=1ex and 1.5em]
        \event{wz0}{(s{\neq}0) \land (r{*}(s{-}1)){=}0 \bigmid \DW{z}{0}}{}
...
\begin{gather*}
  \PR{x}{r}\SEMI \PR{y}{s}\SEMI \IF{s} \THEN \PW{z}{r{*}(s{-}1)} \FI
  \tag{*}\label{eq1}
  \\
  \hbox{\begin{tikzinline}[node distance=1ex and 1.5em]
      \event{rx0}{\DR{x}{1}}{}
      \event{ry0}{\DR{y}{1}}{right=of rx0}
      \event{wz0}{(1{=}r) \limplies (1{=}s) \limplies (s{\neq}0) \land (r{*}(s{-}1)){=}0 \bigmid \DW{z}{0}}{right=of ry0}
...
% \end{gather*}
\begin{gather*}
  \PR{y}{s}\SEMI \IF{s} \THEN \PW{z}{r{*}(s{-}1)} \FI
  \\
  \hbox{\begin{tikzinline}[node distance=1ex and 1.5em]
      \event{ry0}{\DR{y}{1}}{}
      \event{wz0}{(1{=}s) \limplies (s{\neq}0) \land (r{*}(s{-}1)){=}0 \bigmid \DW{z}{0}}{right=of ry0}
