...
which models Java for \mca{} hardware, similar to that of
...
\citet{DBLP:conf/esop/PaviottiCPWOB20}.  In \textsection\ref{sec:additional},
we extend the semantics to include additional features, such as address calculation.
In \textsection{sec:results}, we summarize the results.
