...
\todo{Add text.}
Pugh example for alias analysis and CSE.  Suppose $z{=}x$:
\begin{gather*}
  \PR{x}{r_1} \SEMI
  \PR{z}{r_2} \SEMI  
  \PR{x}{r_3} \SEMI
...
\begin{gather*}
  ...
  \end{gathered}
\end{gather*}
\cite[\textsection8]{DBLP:journals/lmcs/JeffreyR19} and \cite{DBLP:journals/pacmpl/JagadeesanJR20}:
\begin{gather*}
  \taglabel{OOTA4}
  \begin{gathered}
    \PW{y}{x}
