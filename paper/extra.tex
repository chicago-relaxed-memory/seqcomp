...
\begin{gather*}
  ...
  \end{gathered}  
\end{gather*}
\cite{DBLP:conf/esop/SvendsenPDLV18} is disallowed since there is no write
to fulfill $(\DR{y}{1})$.
\begin{gather*}
  \taglabel{OOTA6}
  \begin{gathered}
...
\begin{gather*}
  ...
  \end{gathered}
\end{gather*}
\cite{DBLP:conf/popl/FlurGPSSMDS16} and
...
\subsection{Read-Read Coherence Versus CSE}
